      ...
      <div class="carousel-inner">
        ...
        <div class="item" style="background-image: url(images/slider/2.jpg)">
          <div class="caption">
            ...
            <a data-scroll class="btn btn-start animated fadeInUpBig" href="#services">Star Now</a>
          </div>
        </div>
        <div class="item" style="background-image: url(images/slider/3.jpg)">
          <div class="caption">
            ...
            <a data-scroll class="btn btn-start animated fadeInUpBig" href="#services">Login now</a>
          </div>
        </div>
      </div>
