...
<body>
      ...
      <div class="carousel-inner">
        ...
        <div class="item" style="background-image: url(images/slider/2.jpg)">
          <div class="caption">
            ...
            <a data-scroll class="btn btn-start animated fadeInUpBig" href="#porflolio">Star Now</a>
          </div>
        </div>
        <div class="item" style="background-image: url(images/slider/3.jpg)">
          <div class="caption">
            <h1 class="animated fadeInLeftBig">We are <span>Creative</span></h1>
            <p class="animated fadeInRightBig">Make a life better</p>
            <a data-scroll class="btn btn-start animated fadeInUpBig" href="#team">Star now</a>
          </div>
        </div>
      </div>
          ...
          <div class="col-sm-3">
            <div class="team-member wow flipInY" data-wow-duration="1000ms" data-wow-delay="300ms">
              <div class="member-image">
                <img class="img-responsive" src="images/team/<%= i %>.jpg" alt="">
              </div>
  ...
  <section id="contact">
    <div id="google-map" class="wow fadeIn" data-latitude="40.6010737" data-longitude="-74.1966463" data-wow-duration="1000ms" data-wow-delay="400ms"></div>
            ...
            <div class="col-sm-6">
              <div class="contact-info wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
                ...
                <ul class="address">
                  ...
                  <li><i class="fa fa-envelope"></i> <span> Email:</span><a href="mailto:bobbyray0712@gmail.com"> support@oxygengroup.com</a></li>
                  <li><i class="fa fa-globe"></i> <span> Website:</span> <a href="#">www.oxygengroup.com</a></li>
                </ul>
              </div>                            
            </div>
          </div>
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
          ...
          <div class="col-sm-6">
            <p class="pull-right">Designed by <a href="https://www.facebook.com/Bobbyray0712/">MuD</a></p>
          </div>
        </div>
      </div>
    </div>
