						...
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header">
									...
									<h4 class="modal-title custom_align" id="Heading">Estimate</h4>
								</div>
					...
					<div class="modal fade" id="edit" tabindex="-1" role="dialog"
						...
						<div class="modal-dialog">
							<div class="modal-content" style="width: 400px;">
								...
								<div class="modal-body">
									<p>
										Choice: <input style="margin-left: 36px;" id="check"
											type="radio" name="check" value="True" checked="checked">Good
										<input id="check" style="margin-left: 20px;" type="radio"
											name="check" value="False">Bad
									</p>
									<p>Note:</p>
