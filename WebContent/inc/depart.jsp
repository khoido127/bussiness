...
<div class="col-lg-12">
	<h1 class="page-header">Departs Information</h1>
</div>
<!-- /.col-lg-12 -->
<div class="row">
	<p data-placement="top" data-toggle="tooltip" title="insert">
		<button data-toggle="modal" data-target="#insert"
			style="margin-left: 20px;" class="btn btn-primary btn-sm">Add Depart</button>
	</p>
</div>
<div class="row">
	<div class="col-sm-12">
			...
			<div class="modal-content" style="width: 400px;">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						...
						Depart Name: <input id="Name" class="form-control" type="text"
			...
			<div class="modal-content">
				...
				<div class="modal-footer ">
					...
					<a href="showDepart.htm?view=depart" class="btn btn-default"
						data-dismiss="modal"> <span class="glyphicon glyphicon-remove"></span> Irgone
					</a>
				</div>
...
$(document).ready(function() {
	$("#myData").click(function() {
		var id=$("#ID").val();
		var name=$("#Name").val();
		window.location.href="<%=request.getContextPath()%>/Admin/btnUpdateDepart.htm?id="+ id + "&name=" + name;
