...
<div class="col-lg-12">
	<h1 class="page-header">Staffs Information</h1>
</div>
...
<div class="row">
	<form role="form" action="<%=request.getContextPath()%>/Admin.htm">
		<div class="col-md-4 col-md-offset-0">
			...
			<div class="form-group">
				<label>Birth</label> <input class="form-control" name="birthday"
		...
		<div class="col-md-4 col-md-offset-0">
			...
			<div class="form-group">
				<label>Depart</label> <select name="depart" class="form-control">
			...
			<div class="form-group">
				<label>Role</label> <select name="role" class="form-control">
					<c:choose>
						...
						<c:otherwise>
							<option>Admin</option>
							<option value="false" selected="selected">Staff</option>
		...
		<div class="col-md-8 col-md-offset-0">
			<div class="form-group">
				<label>Note</label>
				<textarea rows="10" cols="8" id="editor" style="width: 100%;"></textarea>
			</div>
		</div>

		<div class="col-md-4 col-md-offset-0">
			<div class="form-group">
				<label>Avatar</label><br /> <img style="border: 1px solid;"
		...
		<button style="margin-left: 20px;" name="btnInsertStaff"
			...
			<c:if test="${control=='edit'}">disabled</c:if>>Add</button>
		<button style="margin-left: 20px;" name="btnUpdateStaff"
			class="btn btn-success btn-sm"
			<c:if test="${control=='insert'}">disabled</c:if>>Update</button>
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="dataTables_length" id="dataTables-example_length">
								<label>Filter <select id="myselect"
								...
								<tbody>
									<c:forEach var="emp" items="${staff}">
										...
										<tr class="odd gradeX">
											...
											<td><a class='btn btn-primary btn-sm' style="margin-top:14px;"
							...
							<div class="modal-content">
								...
								<div class="modal-footer ">
									...
									<a href="showStaff.htm?view=staff" class="btn btn-default"
										...
										class="glyphicon glyphicon-remove"></span> Irgone
									</a>
								</div>
